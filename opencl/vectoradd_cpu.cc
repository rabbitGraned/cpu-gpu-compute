...
// Ищет устройство указанного типа среди всех платформ
...
int main() try {
    ...
    constexpr size_t N = 1 << 26; // 1M элементов — достаточно для замера
    ...
    // Kernel time через профилирование
    ...
    // (опционально) проверка корректности
    bool match = true;
